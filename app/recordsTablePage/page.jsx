    ...
    <div className={styles.container}>
        <div className ={styles.white_container}>
            <div className ={styles.title}>
                <h3 className={styles.h3}> Поздравления всем участникам! </h3>
            </div>
            <table className={styles.table}>
            <thead className={styles.theadCustom}>
            <tr className={styles.level_container}>
                <th className={styles.number}>Место</th>
                <th className={styles.th}>Никнейм</th>
                <th className={styles.number}>Уровень</th>
            </tr>
            </thead>
            <tbody>
            {sortedData.map((user, index) => (
                ...
                </td>                <td className={styles.td}>{user.email}</td>
